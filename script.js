...
var getFiveDayForecast = (event) => {
    ...
    fetch(queryURL)
        ...
        // Loop over the 5 day forecast + build the template HTML
        for (let i = 0; i < response.list.length; i++) {
            ...
            // Displaying mid-day forecasts exclusively
